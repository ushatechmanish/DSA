...
import goodrich.arrays.ch3.RandomNumberGenerator;
import goodrich.arrays.ch3.Scoreboard;

public class UnitTests
{
	private BinarySearch binarySearch;
	RandomNumberGenerator randomNumberUtility;
	int[] emptyArr =
	{};
	int[] arr2 =
	{ 1, 4, 7, 9, 20 };
	...
	public void setup()
	{
		...
		randomNumberUtility = new RandomNumberGenerator();
	}
	...
	public void testInsertionSortNew()
	{
		...
		assertEquals("[1, 2]", Arrays.toString(obj.sortAscending2(new int[]
		{ 2, 1 })));
		assertEquals("[]", Arrays.toString(obj.sortAscending2(new int[]
		{})));
		assertEquals("[1]", Arrays.toString(obj.sortAscending2(new int[]
		{ 1 })));
		assertEquals("[1, 1, 2, 3, 3, 4, 5]", Arrays.toString(obj.sortAscending2(new int[]
		{ 1, 3, 4, 5, 1, 2, 3 })));
	}
	...
	{
		InsertionSort obj = new InsertionSort();
		assertEquals("[2, 1]", Arrays.toString(obj.sortDescending1(new int[]
		{ 2, 1 })));
		assertEquals("[]", Arrays.toString(obj.sortDescending1(new int[]
		{})));
		assertEquals("[1]", Arrays.toString(obj.sortDescending1(new int[]
		{ 1 })));
		assertEquals("[5, 4, 3, 3, 2, 1, 1]", Arrays.toString(obj.sortDescending1(new int[]
		{ 1, 3, 4, 5, 1, 2, 3 })));
		assertEquals("[5, 4, 3]", Arrays.toString(obj.sortDescending1(new int[]
		{ 3, 4, 5 })));
	}
	...
	{
		InsertionSort obj = new InsertionSort();
		assertEquals("[2, 1]", Arrays.toString(obj.sortDescending2(new int[]
		{ 2, 1 })));
		assertEquals("[]", Arrays.toString(obj.sortDescending2(new int[]
		{})));
		assertEquals("[1]", Arrays.toString(obj.sortDescending2(new int[]
		{ 1 })));
		assertEquals("[5, 4, 3, 3, 2, 1, 1]", Arrays.toString(obj.sortDescending2(new int[]
		{ 1, 3, 4, 5, 1, 2, 3 })));
		assertEquals("[5, 4, 3]", Arrays.toString(obj.sortDescending2(new int[]
		{ 3, 4, 5 })));
	}
}
